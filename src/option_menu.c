...
{
    u8 styles[4];
    s32 widthSlow, widthMid, widthFast, widthInstant, xMid, xFast, gap;
    ...
    // Evenly space all 4 choices between x=104 and the right-aligned edge at x=198
    gap = (198 - 104 - widthSlow - widthMid - widthFast - widthInstant) / 3;
